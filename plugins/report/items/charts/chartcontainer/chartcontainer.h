...
class ChartContainer : public Report::ChartDataCollector
{
	Q_OBJECT
	Q_INTERFACES(Report::ChartDataCollector);

public:
	ChartContainer(QGraphicsItem* parent = 0, QObject* parentObject = 0);
